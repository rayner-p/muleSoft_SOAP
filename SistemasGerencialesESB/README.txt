...
a persistence unit "SistemasGerencialesESBPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/ups/edu/SistemasGerencialesESB/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "SistemasGerencialesESB/pom.xml":
...
artifact ("SistemasGerencialesESB.war") is already built. You can build
